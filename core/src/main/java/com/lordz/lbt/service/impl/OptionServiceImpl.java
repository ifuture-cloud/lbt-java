...
import com.lordz.lbt.exception.MissingPropertyException;
...
import com.lordz.lbt.model.dto.OptionDTO;
import com.lordz.lbt.model.entity.Option;
import com.lordz.lbt.model.enums.ValueEnum;
import com.lordz.lbt.model.params.OptionParam;
import com.lordz.lbt.model.properties.*;
import com.lordz.lbt.repository.OptionRepository;
...
public class OptionServiceImpl extends AbstractCrudService<Option, Integer> implements OptionService {
    ...
    public String getBlogBaseUrl() {
        ...
        if (StrUtil.isNotBlank(blogUrl)) {
            ...
            blogUrl = String.format("http://%s:%s", LBTUtils.getMachineIP(), serverPort);
        }
