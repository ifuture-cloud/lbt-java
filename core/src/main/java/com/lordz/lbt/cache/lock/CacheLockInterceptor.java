package com.lordz.lbt.cache.lock;

import com.lordz.lbt.cache.RedisCacheStore;
import com.lordz.lbt.exception.FrequentAccessException;
...
public class CacheLockInterceptor {
    ...
    @Around("@annotation(com.lordz.lbt.cache.lock.CacheLock)")
